...
import { Theme, Section, Image } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"unidays"} />
		<Helmet>
			<title>
				Halo Soul
			</title>
		...
		<Section>
			<Components.Lead sm-text-align="center" sm-font="--headline3">
				Traits Ecosystem
			</Components.Lead>
		</Section>
		<Section>
			<Components.Lead sm-text-align="center" sm-font="--headline4" sm-margin="0px 0px 10px 0px">
				Get your student trait
			</Components.Lead>
			<Components.Lead sm-text-align="center" sm-font="--base">
				powered by
			</Components.Lead>
			<Image src="https://uploads.quarkly.io/62a49aca855d39001fc9020d/images/unidays.png?v=2022-06-11T21:54:19.704Z" display="block" />
		</Section>
		<Section>
			<Components.Inputbar placeholder="Username" sm-margin="5px 0px 5px 0px" />
			<Components.Inputbar placeholder="Password " sm-margin="5px 0px 5px 0px" />
			<Components.Styledbutton type="link" href="/studentcredential" target="_self" />
		</Section>
		<RawHtml>
